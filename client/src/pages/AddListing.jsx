...
export default function AddListing() {
  ...
  return (  
    ...
    <h1 className='text-3xl text-center my-4 font-semibold'>Add a Listing</h1>
       ...
       <button disabled={loading||uploading} className='p-3 uppercase bg-slate-500 text-white rounded-md hover:opacity-90 disabled:opacity-75'>{loading ? 'creating...':'Add Listing'}</button>
