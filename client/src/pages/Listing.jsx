          ...
          {copied && (
            ...
            <div className='flex flex-col  max-w-4xl mx-auto p-3 my-7 gap-4' >
                <p className='text-2xl font-semibold'>{listing.name}-Rs{' '}
                 ...
                 <div className='flex gap-4'>
                    ...
                    {
                        listing.offers && (
                            <p className='bg-green-900 w-full max-w-[200px] text-white pt-1 text-center rounded-md'>
            ...
            </ul>
            {
              currentUser && currentUser._id !==listing.userRef && !contact && (
                <button onClick={()=>setContact(true)} className='uppercase bg-slate-700 text-white rounded-md p-3 hover:opacity-90'>contact  landlord</button>
              )
            }
            {  contact &&
